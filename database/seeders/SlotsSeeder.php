...
class SlotsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Slot::updateOrCreate(['id_slots' => 1],[
            'display_name' => "07:30 - 09:10",
            'start_slot' => "07:30",
            'end_slot' => "09:10",
        ]);

        Slot::updateOrCreate(['id_slots' => 2],[
            'display_name' => "09:20 - 11:00",
            'start_slot' => "09:20",
            'end_slot' => "11:00",
        ]);
        Slot::updateOrCreate(['id_slots' => 3],[
            'display_name' => "11:10 - 12:50",
            'start_slot' => "11:10",
            'end_slot' => "12:50",
        ]);
        Slot::updateOrCreate(['id_slots' => 4],[
            'display_name' => "13:30 - 15:10",
            'start_slot' => "13:30",
            'end_slot' => "15:10",
        ]);
        Slot::updateOrCreate(['id_slots' => 5],[
            'display_name' => "15:20 - 17:00",
            'start_slot' => "15:20",
            'end_slot' => "17:00",
        ]);
        Slot::updateOrCreate(['id_slots' => 6],[
            'display_name' => "17:10 - 18:50",
            'start_slot' => "17:10",
            'end_slot' => "18:50",
        ]);
        Slot::updateOrCreate(['id_slots' => 7],[
            'display_name' => "19:00 - 20:40",
            'start_slot' => "19:00",
            'end_slot' => "20:40",
        ]);
        Slot::updateOrCreate(['id_slots' => 8],[
